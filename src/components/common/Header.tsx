      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <a href={catalogHref} className="flex items-center space-x-3 group">
            <div className="w-10 h-10 bg-[#2E6A77] flex items-center justify-center rounded-full text-white font-heading text-xl transition-transform duration-300 group-hover:scale-105">
              L
            </div>
